...
function RenderRowsDashboard({ headerData, rowsData, setactiveEvent, activeEvent }: RenderHeaderProps): React.ReactElement {
                ...
                rowsData.map((row, index) => {
                    ...
                    return (
                        <RowTable
                            ...
                            style={{ backgroundColor: activeEvent === row.id && 'rgba(160, 201, 255,0.5)' }}
                        >
                            {cells}
                        </RowTable>
                    );
...
export default RenderRowsDashboard
